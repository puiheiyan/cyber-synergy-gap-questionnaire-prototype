        ...
        return (
            <div>
                ...
                <div className="questionContainer">
                    <h1> 
                        What number of generations for password reuse? Does the organization define the number of password generations to be prohibited from password
                    </h1>
                    <TextField margin="normal" className="textArea" inputProps={{style: {fontSize: 25}}} InputLabelProps={{style: {fontSize: 25}}} />

                    <h1> 
                        Does the information systems prohibits password reuse for the defined number of generations?
                    </h1>
